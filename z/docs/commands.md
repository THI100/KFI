...
3. Add:
  ...
  - Detailed walk through:
    1. It needs to verify the path (see if the file is existent), in case the all bool is allowed, check all the folder content.
    2. Check the ignored paths on .vaultbypass, and remove those from the path vector.
